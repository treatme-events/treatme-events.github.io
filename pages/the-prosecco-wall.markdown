...
<div id="prosecco-wall" class="row pt-5 pb-5">
			<div class="col-12 col-sm-6 mb-5">
				<img class="image-shadow" style="width: 100%;" src="/assets/images/home/pro-wall.jpg" alt="">
			</div>
...
<div class="col-12 col-sm-4 order-first mb-5">
        <img class="image-shadow" style="width: 100%;" src="{{site.baseurl}}/assets/images/prosecco/p1.jpg" alt="">
    </div>	
    <div class="col-12 col-sm-4 order-first mb-5">
        <img class="image-shadow" style="width: 100%;" src="{{site.baseurl}}/assets/images/prosecco/p2.jpg" alt="">
    </div>	
    <div class="col-12 col-sm-4 order-first mb-5">
        <img class="image-shadow" style="width: 100%;" src="{{site.baseurl}}/assets/images/prosecco/p3.jpg" alt="">
    </div>	
</div>
